...
WESTEROS_SOC_PKGDIR = "$(TOP_DIR)/package/westeros-sink"
define WESTEROS_SOC_APPLY_LOCAL_PATCHES
  $(APPLY_PATCHES) $(@D) $(WESTEROS_SOC_PKGDIR) 0001-synaptics_support.patch.conditional;
endef
ifeq ($(BR2_PACKAGE_MARVELL_AMPSDK),y)
WESTEROS_SOC_POST_PATCH_HOOKS += WESTEROS_SOC_APPLY_LOCAL_PATCHES
endif
