...
WPEFRAMEWORK_VERSION = cb201d8acd060dd1553cc82591896f485f15cd1c
...
WPEFRAMEWORK_CONF_OPTS += -DINSTALL_HEADERS=ON -DPLUGINHOST_WEB_UI=ON
...
WPEFRAMEWORK_CONF_OPTS += -DFRAMEWORK_VIRTUALINPUT=ON		
endif

ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_PROVISIONPROXY),y)		
WPEFRAMEWORK_CONF_OPTS += -DFRAMEWORK_PROVISIONPROXY=ON		
WPEFRAMEWORK_DEPENDENCIES = libprovision
endif

ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_TEST_CYCLICINSPECTOR),y)
WPEFRAMEWORK_CONF_OPTS += -DFRAMEWORK_TEST_CYCLICINSPECTOR=ON
endif
...
WPEFRAMEWORK_POST_INSTALL_TARGET_HOOKS += FRAMEWORK_POST_TARGET_INITD
endif
