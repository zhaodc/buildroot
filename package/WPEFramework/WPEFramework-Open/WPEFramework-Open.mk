WPEFRAMEWORK_OPEN_VERSION = 4be055e6eceb3162f4431db99338eaad0b0d252a
...
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_OPEN_REMOTECONTROL_IRNEXUS),y)
WPEFRAMEWORK_OPEN_CONF_OPTS += -DOPEN_PLUGIN_REMOTECONTROL_IRNEXUS=ON
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_OPEN_REMOTECONTROL_IRNEXUS_MODE),)
WPEFRAMEWORK_OPEN_CONF_OPTS += -DOPEN_PLUGIN_REMOTECONTROL_IRMODE="$(call qstrip,$(BR2_PACKAGE_WPEFRAMEWORK_OPEN_REMOTECONTROL_IRNEXUS_MODE))"
endif
endif
endif
...
WPEFRAMEWORK_OPEN_CONF_OPTS += -DOPEN_PLUGIN_WEBKITBROWSER_STARTURL=$(BR2_PACKAGE_WPEFRAMEWORK_OPEN_WEBKITBROWSER_STARTURL)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_OPEN_WEBKITBROWSER_USERAGENT),)
WPEFRAMEWORK_OPEN_CONF_OPTS += -DOPEN_PLUGIN_WEBKITBROWSER_USERAGENT=$(BR2_PACKAGE_WPEFRAMEWORK_OPEN_WEBKITBROWSER_USERAGENT)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_OPEN_WEBKITBROWSER_MEMORYPROFILE),)
WPEFRAMEWORK_OPEN_CONF_OPTS += -DOPEN_PLUGIN_WEBKITBROWSER_MEMORYPROFILE=$(BR2_PACKAGE_WPEFRAMEWORK_OPEN_WEBKITBROWSER_MEMORYPROFILE)
endif
ifneq ($(BR2_PACKAGE_WPEFRAMEWORK_OPEN_WEBKITBROWSER_MEMORYPRESSURE),)
WPEFRAMEWORK_OPEN_CONF_OPTS += -DOPEN_PLUGIN_WEBKITBROWSER_MEMORYPRESSURE=$(BR2_PACKAGE_WPEFRAMEWORK_OPEN_WEBKITBROWSER_MEMORYPRESSURE)
endif
...
WPEFRAMEWORK_OPEN_CONF_OPTS += -DOPEN_PLUGIN_WEBKITBROWSER_DISKCACHE=$(BR2_PACKAGE_WPEFRAMEWORK_OPEN_WEBKITBROWSER_DISKCACHE)
endif
